...
import com.example.foodappclient.databinding.ActivityAboutBinding;
...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.txtEmail.setOnClickListener(v -> {
            try{
                ...
                String[] recipients = {"bhavyamanne09@gmail.com"};
        ...
        binding.txtWhatsapp.setOnClickListener(v -> sendMessage("9848580601"));
    }
    ...
    private void sendMessage(String phoneNumber){
        ...
        String message = "Hello Thanks For Using *GRIHASTA*.";
